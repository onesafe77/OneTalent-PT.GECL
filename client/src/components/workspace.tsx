...
import MonitoringSimperPerpanjangan from "@/pages/monitoring-simper-perpanjangan";
...
import { PrasaranaFormPage, PrasaranaViewPage } from "@/pages/hse/ko/spip/prasarana-detail-page";
...
const workspaceRoutes = [
  ...
  { path: "/workspace/monitoring-simper-perpanjangan", component: MonitoringSimperPerpanjangan, title: "Monitoring Perpanjangan SIMPER" },
        ...
        <div className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ease-in-out ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-0'}`}>
          ...
          <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 dark:bg-gray-900 p-0 sm:p-4 lg:p-6 pb-20 sm:pb-4 lg:pb-6">
            <Switch>
              ...
              <Route path="/workspace/monitoring-simper-perpanjangan" component={MonitoringSimperPerpanjangan} />
              ...
              */}
              ...
              <Route path="/workspace/hse/ko/spip/instalasi/tambah">
                {(params) => <InstalasiFormPage />}
              </Route>
              <Route path="/workspace/hse/ko/spip/instalasi/:id/edit">
                {(params) => <InstalasiFormPage id={params.id} />}
              </Route>
              <Route path="/workspace/hse/ko/spip/instalasi/:id">
                {(params) => <InstalasiViewPage id={params.id} />}
              </Route>
