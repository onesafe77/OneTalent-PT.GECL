                ...
                {isLoading ? (
                    ...
                    <Card className="text-center py-10">
                        <CardContent className="pt-0">
                            ...
                            <EmptyStateCreateButton href="/workspace/sidak/workshop/new" label="Buat Sidak Baru" icon={ClipboardCheck} className="mt-4 bg-red-600 hover:bg-red-700 text-white" size="sm" />
                        </CardContent>
                    </Card>
                ) : (
