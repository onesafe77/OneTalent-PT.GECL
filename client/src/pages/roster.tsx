...
export default function Roster() {
      ...
      <CardHeader className="px-3 sm:px-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-[28px] font-semibold tracking-[-0.03em] text-foreground">Roster Kerja</CardTitle>
          </div>
 ...
 data-testid="search-name-input"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuLabel className="text-xs text-foreground">Dept HSE</DropdownMenuLabel>
            ...
            <Button onClick={() => setIsDialogOpen(true)} className="w-full sm:w-auto text-xs sm:text-sm bg-gray-950 hover:bg-gray-950 text-white ml-2 shadow-sm" data-testid="add-roster-button">
        ...
        {viewMode === 'list' ? (
          ...
          <>
            ...
            <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
              <StatTile label="Dijadwalkan" value={stats.scheduled} icon={Calendar} />
              <StatTile label="Hadir" value={stats.present} icon={CheckCircle} />
              <StatTile label="Belum Hadir" value={stats.absent} icon={Clock} />
              <StatTile label="Cuti" value={stats.onLeave} icon={Users} />
            </div>
 ...
 data-testid={`roster-fit-to-work-${roster.employeeId}`}
                        ...
                        <td className="py-3 px-4">
                          <Badge
 className={roster.hasAttended ? 'bg-muted text-foreground' : 'bg-gray-100 text-gray-900 dark:bg-red-900 dark:text-red-300'}
                          >
